...
def main() -> None:
    ...
    st.markdown('<div class="development-notice">Aero AI masih dalam tahap pengembangan dan dipelihara oleh <b>DynamiHatch</b>. Setiap pembaruan diprioritaskan untuk kejelasan data, ketahanan sistem, dan pengalaman riset market yang bertanggung jawab.</div>', unsafe_allow_html=True)
